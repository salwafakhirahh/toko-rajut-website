...
import { addReview } from '../../services/supabaseClient';
            ...
            <div className="glass rounded-2xl p-6 shadow-2xl border border-white/50 relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 bg-dustyRose text-white rounded-lg hover:bg-coral transition-all font-semibold flex items-center justify-center gap-2 disabled:opacity-50"
                >
